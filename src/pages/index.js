...
listenForUrlChangesMobileMenu()
            ...
            <main className={styles['main']}>
              ...
              <div className={styles['buttons']}>
                <a href="#Pricing" className={styles['link08']}>
                  ...
                  >
                    <span className={styles['text02']}>Get started</span>
                  </div>
                </a>
                <a href="#features" className={styles['link09']}>
                  ...
                  >
                    <span className={styles['text03']}>View features</span>
                  </div>
                </a>
              </div>
            </main>
      ...
      <section className={styles['who-we-are']}>
        <h2 className={styles['text04']}>Who we are</h2>
        <div className={styles['features']}>
          <header
            className={` ${styles['feature']} ${projectStyles['feature']} ${projectStyles['feature-active']} `}
          >
            <h3 className={styles['text05']}>Perception</h3>
          ...
          >
            <h3 className={styles['text07']}>Speed</h3>
          ...
          >
            <h3 className={styles['text09']}>Distinction</h3>
      ...
      <section id="features" className={styles['section']}>
        <header className={styles['header1']}>
          <h2 className={styles['text11']}>Why do you need a website?</h2>
        ...
        <section className={styles['note1']}>
          ...
          <div className={styles['content02']}>
            ...
            <div className={styles['explore-more']}>
              <p className={styles['text13']}>Explore more -&gt;</p>
            </div>
        ...
        <section className={styles['note2']}>
          ...
          <div className={styles['content03']}>
            ...
            <a href="#Pricing" className={styles['link11']}>
              ...
              >
                <span className={styles['text15']}>Get started</span>
              </div>
            </a>
          </div>
        </section>
        ...
        <main className={styles['pricing1']}>
          <header className={styles['header4']}>
            ...
            <div className={styles['right']}>
              <p
                className={` ${styles['paragraph2']} ${projectStyles['section-description']} `}
              >
        ...
        <div className={styles['help']}>
          ...
          >
            <div className={styles['contact-support']}>
              <p className={styles['text27']}>Contact support -&gt;</p>
            </div>
          </a>
        </div>
      </section>
      <section className={styles['reviews']}>
        ...
        <div className={styles['view-more']}>
          <p className={styles['text28']}>View more</p>
        </div>
      </section>
          ...
          <main className={styles['subscribe']}>
            <main className={styles['main5']}>
              ...
              >
                ...
                >
                  <span className={styles['text31']}>-&gt;</span>
                  <span type="submit" className={styles['text32']}>
